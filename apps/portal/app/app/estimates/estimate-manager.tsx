...
import { formatDateForDisplay, formatDateTimeForDisplay } from "@/lib/calendar/dates";
...
type EstimateManagerCopy = {
  ...
  share: {
    ...
    customerDecision: (value: string, decisionName: string | null | undefined) => string;
  ...
  messages: {
    ...
    taxRateUpdated: (taxRatePercent: string, jurisdiction: string, zipCode: string) => string;
...
function getEstimateManagerCopy(locale: string): EstimateManagerCopy {
  if (locale.startsWith("es")) {
    return {
      page: {
        title: "Estimados",
        subtitle: "Prepara estimados listos para el cliente para {orgName}, sigue la revision y mueve el trabajo aprobado a agenda o facturacion.",
        newEstimate: "Nuevo estimado",
        listTitle: "Estimados",
        listSubtitle: "Busca por cliente, numero de estimado o estado para reabrir el estimado correcto rapido.",
        search: "Buscar",
        searchPlaceholder: "Numero de estimado, cliente o lead",
        status: "Estado",
        loadingList: "Cargando estimados...",
        emptyTitle: "Aun no hay estimados.",
        emptyBody: "Crea tu primer estimado interno para empezar a cotizar trabajo.",
        noCustomerAttached: "Sin cliente adjunto",
        noSiteDetails: "Aun no hay detalles del sitio",
      },
      workspace: {
        title: "Espacio del estimado",
        titleWithNumber: (estimateNumber) => `${estimateNumber} Espacio del estimado`,
        subtitle: "Da forma al estimado para el cliente, confirma que este listo y mueve el trabajo aprobado a operaciones.",
        emptySubtitle: "Selecciona un estimado para dar forma al alcance, precio y siguiente paso.",
      ...
      cards: {
        ...
        refreshCustomerView: "Guarda los cambios para refrescar la vista del cliente usada al compartir.",
      },
      form: {
        projectSummaryTitle: "Resumen del proyecto",
        projectSummaryBody: "Configura el titulo visible para el cliente, los detalles de la propiedad y los terminos antes de enviarlo.",
        ...
        autoTaxBody: "El impuesto automatico funciona para ZIP de trabajos en Washington. Puedes escribir una tarifa manual cuando quieras.",
        validUntil: "Valido hasta",
        projectSummaryField: "Resumen del proyecto",
        projectSummaryPlaceholder: "Resumen breve del proyecto visible para el cliente.",
        internalNotes: "Notas internas",
        internalNotesPlaceholder: "Notas internas de alcance, recordatorios de seguimiento o contexto solo para el contratista.",
        customerTerms: "Terminos para el cliente",
        customerTermsPlaceholder: "Garantia, terminos de pago, notas de agenda o detalles visibles para el cliente.",
      },
      scope: {
        ...
        emptyBody: "Agrega mano de obra, materiales del catalogo o alcance personalizado antes de enviar este estimado.",
      ...
      share: {
        ...
        customerDecision: (value, decisionName) => `Decision del cliente ${value}${decisionName ? ` por ${decisionName}` : ""}`,
        latestRecipient: "Ultimo destinatario:",
        secureLink: "Enlace seguro del estimado",
        copying: "Copiando...",
        copyLink: "Copiar enlace",
        rawUrlMissing: "Existe un enlace seguro, pero la URL ya no puede recargarse desde almacenamiento. Genera un enlace nuevo si necesitas copiarlo otra vez.",
        ...
        unsavedEdits: "Tienes cambios visibles para el cliente sin guardar. Guarda primero si quieres que el estimado compartido coincida con lo que ves aqui.",
      },
      actions: {
        ...
        positiveTotalWarning: "Define un total positivo antes de crear una factura borrador desde este estimado.",
      },
      activity: {
      ...
      review: {
        ...
        declinedDetail: (value) => `El cliente pidio cambios ${value || "recientemente"}.`,
        viewedDetail: (value) => `Visto ${value || "recientemente"}.`,
        sentDetail: (value) => `Enviado ${value || "recientemente"}.`,
        expiredDetail: "Refresca la version para el cliente antes de volver a pedir aprobacion.",
      ...
      nextStep: {
        ...
        createEstimateDetail: "Empieza un nuevo estimado, valora el alcance y dejalo listo para el cliente.",
        moveApprovedDetail: "Crea el trabajo, envialo a despacho o prepara la factura borrador.",
        reviseResendDetail: "Revisa la nota del cliente, ajusta el estimado y envia un enlace nuevo.",
        followUpWarmDetail: "El cliente ya lo vio. Da seguimiento o espera aprobacion y luego mueve el trabajo a operaciones.",
        getReviewDetail: "Envia el estimado y deja claro el siguiente paso para cerrarlo rapido.",
        createCustomerViewDetail: "Genera el enlace seguro para el cliente o envia el estimado tan pronto como el alcance este listo.",
      },
      issues: {
        title: "Agrega un titulo especifico para el estimado.",
        customer: "Adjunta un cliente antes de compartir o enviar este estimado.",
        lineItems: "Agrega al menos una partida antes de compartir o enviar este estimado.",
        total: "Define un total positivo antes de compartir o enviar este estimado.",
      },
      shareStates: {
        noLink: "Sin enlace",
        active: "Activo",
      ...
      messages: {
        ...
        readOnlyCreate: "Los usuarios de solo lectura no pueden crear estimados.",
        failedCreate: "No se pudo crear el estimado.",
        created: (estimateNumber) => `Estimado ${estimateNumber} creado.`,
        enterSiteAddress: "Ingresa la direccion del sitio antes de buscar el impuesto.",
        ...
        readOnlySave: "Los usuarios de solo lectura no pueden guardar estimados.",
        notReadyForStatus: (statusLabel, issues) => `El estimado no esta listo para ${statusLabel.toLowerCase()}. ${issues}`,
        failedSave: "No se pudo guardar el estimado.",
        saved: (estimateNumber) => `Estimado ${estimateNumber} guardado.`,
        notReadyToSend: (issues) => `El estimado no esta listo para enviarse. ${issues}`,
        failedSend: "No se pudo enviar el estimado.",
        sentManualShare: "El estimado se marco como enviado para compartirlo manualmente.",
        positiveTotalBeforeInvoice: "Define un total positivo antes de crear una factura desde este estimado.",
        failedConvert: "No se pudo convertir el estimado.",
        sentToDispatch: (estimateNumber) => `Estimado ${estimateNumber} enviado a despacho.`,
        jobCreated: (jobId) => `Trabajo creado: ${jobId}`,
        invoiceDraftCreated: (invoiceId) => `Factura borrador creada: ${invoiceId}`,
        failedArchive: "No se pudo archivar el estimado.",
        archived: (estimateNumber) => `Estimado ${estimateNumber} archivado.`,
        notReadyToShare: (issues) => `El estimado no esta listo para compartirse. ${issues}`,
        ...
        shareLinkCopyFailed: "No se pudo copiar el enlace automaticamente. Copialo manualmente desde el campo.",
        invalidStatusTransition: (from, to) => `No puedes mover este estimado de ${from} a ${to}.`,
      },
    };
  }
  ...
  return {
    page: {
      title: "Estimates",
      subtitle: "Prepare customer-ready estimates for {orgName}, track review, and move approved work into scheduling or invoicing.",
      newEstimate: "New Estimate",
      listTitle: "Estimates",
      listSubtitle: "Search by customer, estimate number, or review status to reopen the right estimate fast.",
      search: "Search",
    ...
    workspace: {
      ...
      titleWithNumber: (estimateNumber) => `${estimateNumber} Estimate Workspace`,
      subtitle: "Shape the customer-facing estimate, confirm readiness, and move approved work into operations.",
      emptySubtitle: "Select an estimate to shape its scope, pricing, and next step.",
    ...
    cards: {
      ...
      refreshCustomerView: "Save changes to refresh the live customer view used for sharing.",
    },
    form: {
      projectSummaryTitle: "Project Summary",
      projectSummaryBody: "Set the customer-facing title, property details, and estimate terms before you send it.",
      ...
      autoTaxBody: "Auto tax is built in for Washington job ZIP codes. Type a manual rate any time to override it.",
      validUntil: "Valid until",
      projectSummaryField: "Project Summary",
      projectSummaryPlaceholder: "Short customer-facing overview of the project.",
      internalNotes: "Internal Notes",
      internalNotesPlaceholder: "Internal scope notes, follow-up reminders, or contractor-only context.",
      customerTerms: "Customer Terms",
      customerTermsPlaceholder: "Warranty, payment terms, scheduling notes, or customer-facing details.",
    },
    scope: {
      ...
      emptyBody: "Add labor, catalog materials, or custom scope before sending this estimate.",
    ...
    share: {
      ...
      customerDecision: (value, decisionName) => `Customer decision ${value}${decisionName ? ` by ${decisionName}` : ""}`,
      latestRecipient: "Latest recipient:",
      secureLink: "Secure estimate link",
      copying: "Copying...",
      copyLink: "Copy Link",
      rawUrlMissing: "A secure link exists but the raw URL cannot be reloaded from storage. Generate a fresh link if you need to copy it again.",
      ...
      unsavedEdits: "You have unsaved customer-facing edits. Save first if you want the shared estimate to match what you see here.",
    },
    actions: {
      save: "Save Estimate",
      saving: "Saving...",
      ...
      archiving: "Archiving...",
      positiveTotalWarning: "Set a positive total before creating an invoice draft from this estimate.",
    },
    activity: {
    ...
    review: {
      ...
      declinedDetail: (value) => `Customer asked for changes ${value || "recently"}.`,
      viewedDetail: (value) => `Viewed ${value || "recently"}.`,
      sentDetail: (value) => `Sent ${value || "recently"}.`,
      expiredDetail: "Refresh the customer-facing version before asking for approval.",
    ...
    nextStep: {
      ...
      createEstimateDetail: "Start a new estimate, price the scope, and get it customer-ready.",
      moveApprovedDetail: "Create the job, send it to dispatch, or spin up the invoice draft.",
      reviseResendDetail: "Review the customer note, adjust the estimate, and send a fresh link.",
      followUpWarmDetail: "They have already seen it. Follow up or wait for approval, then move the work into ops.",
      getReviewDetail: "Send the estimate and keep the next step clear so it closes quickly.",
      createCustomerViewDetail: "Generate the secure customer link or send the estimate as soon as the scope is ready.",
    },
    issues: {
      title: "Add a specific estimate title.",
      customer: "Attach a customer before sharing or sending this estimate.",
      lineItems: "Add at least one line item before sharing or sending this estimate.",
    ...
    messages: {
      ...
      notReadyForStatus: (statusLabel, issues) => `Estimate is not ready for ${statusLabel.toLowerCase()}. ${issues}`,
      ...
      positiveTotalBeforeInvoice: "Set a positive total before creating an invoice from this estimate.",
      failedConvert: "Failed to convert estimate.",
      sentToDispatch: (estimateNumber) => `Estimate ${estimateNumber} sent to dispatch.`,
      ...
      shareLinkCopyFailed: "Could not copy the share link automatically. Copy it manually from the field.",
      invalidStatusTransition: (from, to) => `Cannot move this estimate from ${from} to ${to}.`,
    },
  };
}
...
function getEstimateCustomerFacingIssuesLocalized(input: {
  ...
  if (!(input.customerName && input.customerName.trim()) && !(input.leadLabel && input.leadLabel.trim())) {
...
function formatWorkflowTimestamp(value: string | null, locale: string): string | null {
...
function formatShareStateLabelLocalized(value: string | null | undefined, copy: EstimateManagerCopy): string {
...
function formatEstimateStatusLabelLocalized(status: string, translate: (key: string) => string): string {
  return translate(status.toLowerCase());
}

function formatEstimateItemTypeLabelLocalized(type: EstimateItemRow["type"], copy: EstimateManagerCopy): string {
...
function describeEstimateActivityTypeLocalized(type: string, copy: EstimateManagerCopy): string {
  switch (type) {
    case "CREATED":
...
export default function EstimateManager({
  ...
  useEffect(() => {
    ...
    async function loadEstimates() {
      ...
      try {
        ...
        if (cancelled) return;
        setEstimates([]);
        setError(loadError instanceof Error ? loadError.message : copy.messages.failedLoadEstimates);
      } finally {
        if (!cancelled) {
  ...
  useEffect(() => {
    ...
    async function loadEstimate() {
      ...
      try {
        ...
        setSelectedEstimate(null);
        setForm(emptyFormState);
        setError(loadError instanceof Error ? loadError.message : copy.messages.failedLoadEstimate);
      } finally {
        if (!cancelled) {
          setLoadingDetail(false);
        }
  ...
  }, [focusTarget, loadingDetail, mobileMode, selectedEstimate, selectedEstimate?.id]);
  ...
  const handleCreateEstimate = useCallback(async () => {
    ...
    try {
      ...
      setError(createError instanceof Error ? createError.message : copy.messages.failedCreate);
    } finally {
      setSaving(false);
    }
  ...
  async function handleLookupTaxRate(input?: { silent?: boolean }) {
    ...
    try {
      ...
      setError(null);
      setNotice(
        copy.messages.taxRateUpdated(payload.taxRatePercent, payload.taxJurisdiction || "", payload.taxZipCode || ""),
      );
    } catch (lookupError) {
      if (!input?.silent) {
        setError(lookupError instanceof Error ? lookupError.message : copy.messages.failedLookupTax);
      }
    } finally {
  ...
  async function handleSaveEstimate() {
    ...
    if (requiresEstimateCustomerFacingReadiness(form.status) && draftCustomerFacingIssues.length > 0) {
      setError(
    ...
    try {
      ...
      setError(saveError instanceof Error ? saveError.message : copy.messages.failedSave);
    } finally {
      setSaving(false);
    }
  }
  ...
  async function handleSendEstimate() {
    ...
    try {
      ...
      setError(sendError instanceof Error ? sendError.message : copy.messages.failedSend);
    } finally {
      setSending(false);
    }
  }
  ...
  async function handleConvertEstimate(createInvoice: boolean) {
    ...
    try {
      ...
      const notices = [copy.messages.sentToDispatch(payload.estimate.estimateNumber)];
      if (payload.jobId) notices.push(copy.messages.jobCreated(payload.jobId));
      if (payload.invoiceId) notices.push(copy.messages.invoiceDraftCreated(payload.invoiceId));
      setNotice(notices.join(" "));
      setRefreshToken((current) => current + 1);
    } catch (convertError) {
      setError(convertError instanceof Error ? convertError.message : copy.messages.failedConvert);
    } finally {
      setConverting(false);
    }
  }
  ...
  async function handleArchiveEstimate() {
    ...
    try {
      ...
      setError(archiveError instanceof Error ? archiveError.message : copy.messages.failedArchive);
    } finally {
      setArchiving(false);
    }
  }
  ...
  async function handleGenerateShareLink() {
    ...
    try {
      ...
      if (!response.ok || !payload?.ok || !payload.estimate || !payload.share?.url) {
        throw new Error(payload?.error || copy.messages.failedGenerateShareLink);
      }
      ...
      setError(shareError instanceof Error ? shareError.message : copy.messages.failedGenerateShareLink);
    } finally {
      setSharing(false);
    }
  }
  ...
  async function handleRevokeShareLink() {
    ...
    try {
      ...
      setError(revokeError instanceof Error ? revokeError.message : copy.messages.failedRevokeShareLink);
    } finally {
  ...
  const customerReadyLabel =
    draftCustomerFacingIssues.length === 0 ? copy.cards.ready : copy.cards.needsDetails;
  ...
  const reviewStatusDetail = selectedEstimate
    ? selectedEstimate.status === "APPROVED"
      ? copy.review.approvedDetail(formatWorkflowTimestamp(selectedEstimate.approvedAt, displayLocale))
      : selectedEstimate.status === "DECLINED"
        ? copy.review.declinedDetail(formatWorkflowTimestamp(selectedEstimate.declinedAt, displayLocale))
        : selectedEstimate.status === "VIEWED"
          ? copy.review.viewedDetail(formatWorkflowTimestamp(selectedEstimate.customerViewedAt, displayLocale))
          : selectedEstimate.status === "SENT"
            ? copy.review.sentDetail(formatWorkflowTimestamp(selectedEstimate.sentAt || selectedEstimate.sharedAt, displayLocale))
            : selectedEstimate.status === "EXPIRED"
  ...
  return (
    <div className="estimate-module-shell">
      ...
      <div className="estimate-module-grid">
        <section className="card" id="estimate-workspace" ref={workspaceSectionRef} style={{ scrollMarginTop: 24 }}>
          <div className="invoice-header-row">
            <div className="stack-cell">
              ...
              {estimates.map((estimate) => (
                ...
                >
                  <div className="stack-cell">
                    ...
                    <span className="muted">{estimate.customerName || estimate.lead?.label || copy.page.noCustomerAttached}</span>
                  </div>
                  <div className="quick-meta">
                    <span className="badge">{formatEstimateStatusLabelLocalized(estimate.status, statusT)}</span>
                    <span className="badge">{formatEstimateCurrency(estimate.total)}</span>
                  </div>
                  <span className="muted">{estimate.siteAddress || estimate.projectType || copy.page.noSiteDetails}</span>
                </button>
              ))}
            </div>
          )}
        ...
        <section className="card">
          <div className="invoice-header-row">
            <div className="stack-cell">
              <h3>{selectedEstimate ? copy.workspace.titleWithNumber(selectedEstimate.estimateNumber) : copy.workspace.title}</h3>
              <p className="muted">
                {selectedEstimate
            ...
            {selectedEstimate && pathname !== `/app/estimates/${selectedEstimate.id}` ? (
              <div className="portal-empty-actions">
                <Link className="btn secondary" href={buildPath({ estimateId: selectedEstimate.id, orgId, internalUser, mobileMode, focus: "editor" })}>
            ...
            <>
              <section className="estimate-module-section">
                <div className="estimate-proposal-grid">
                  <article className="estimate-proposal-card">
                    <span className="estimate-share-eyebrow">{copy.cards.projectSummary}</span>
                    <strong>{form.title || copy.cards.addEstimateTitle}</strong>
                    <span>{form.customerName || linkedLead?.label || copy.cards.attachCustomerOrLead}</span>
                    <span className="muted">{form.siteAddress || copy.cards.addSiteAddress}</span>
                    <div className="estimate-proposal-status-inline">
                      <span className="badge">{form.projectType || copy.cards.projectType}</span>
                      {form.validUntil ? (
                        <span className="badge">
                          {copy.cards.validUntil} {formatDateForDisplay(`${form.validUntil}T12:00:00.000Z`, { locale: displayLocale })}
                        </span>
                      ) : null}
                    </div>
                  </article>
                  ...
                  <article className="estimate-proposal-card">
                    <span className="estimate-share-eyebrow">{copy.cards.customerReady}</span>
                    ...
                    {readinessChanged ? (
                      <span className="muted">{copy.cards.refreshCustomerView}</span>
                    ) : null}
                  </article>

                  <article className="estimate-proposal-card">
                    <span className="estimate-share-eyebrow">{copy.cards.nextStep}</span>
                    <strong>{nextStepTitle}</strong>
                    <span className="muted">{nextStepDetail}</span>
                    <div className="estimate-proposal-status-inline">
                      <span className="badge">{formatShareStateLabelLocalized(selectedEstimate.latestShareLink?.state, copy)}</span>
                      <span className="badge">{formatEstimateStatusLabelLocalized(selectedEstimate.status, statusT)}</span>
                    </div>
                  </article>
                </div>
              </section>
                        ...
                        if (!canTransitionEstimateStatus(selectedEstimate.status, nextStatus)) {
                          setError(
                            copy.messages.invalidStatusTransition(
                              formatEstimateStatusLabelLocalized(selectedEstimate.status, statusT),
                              formatEstimateStatusLabelLocalized(nextStatus, statusT),
                            ),
                          );
                          return;
                        }
                ...
                <div className="grid two-col">
                  <label>
                    ...
                    <div className="inline" style={{ alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                      ...
                      >
                        {lookingUpTax ? copy.form.lookingUp : copy.form.autoFromZip}
                      </button>
                    </div>
                    <span className="muted">
                      {form.taxRateSource === "WA_DOR" && form.taxZipCode
                        ? copy.form.autoTaxFrom(form.taxZipCode, form.taxJurisdiction)
                    ...
                    {form.lineItems.map((line, index) => (
                      <article className="estimate-scope-editor-card" key={line.id}>
                        <div className="estimate-scope-editor-card-header">
                          <div className="stack-cell">
                            <span className="estimate-share-eyebrow">{copy.scope.item(index + 1)}</span>
                            <label>
                              {copy.scope.itemName}
                              <input
                                value={line.name}
                          ...
                          <div className="estimate-scope-editor-total">
                            <span className="muted">{formatEstimateItemTypeLabelLocalized(line.type, copy)}</span>
                        ...
                        <div className="estimate-scope-editor-fields">
                          <label>
                            ...
                            <select value={line.type} onChange={(event) => updateLine(line.id, { type: event.currentTarget.value as EstimateItemRow["type"] })}>
                              <option value="MATERIAL">{copy.scope.catalogMaterial}</option>
                              <option value="CUSTOM_MATERIAL">{copy.scope.customScope}</option>
              ...
              <section className="estimate-module-section">
                ...
                <div className="estimate-share-internal-card" style={{ marginTop: 12 }}>
                  ...
                  <div className="estimate-share-inline-meta">
                    <span className="badge">
                      {selectedEstimate.latestShareLink
                        ? formatShareStateLabelLocalized(selectedEstimate.latestShareLink.state, copy)
                        : copy.share.noLink}
                    </span>
                    <span className="muted">
                      {selectedEstimate.sharedAt
                        ? copy.share.lastShared(formatDateTimeForDisplay(selectedEstimate.sharedAt, {
                            month: "short",
                            day: "numeric",
                            year: "numeric",
                            hour: "numeric",
                    ...
                    {selectedEstimate.shareExpiresAt ? (
                      <span className="muted">{copy.share.expires(formatDateTimeForDisplay(selectedEstimate.shareExpiresAt, {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                        hour: "numeric",
                        minute: "2-digit",
                      }, { locale: displayLocale }))}</span>
                    ) : null}
                    {selectedEstimate.customerViewedAt ? (
                      <span className="muted">{copy.share.customerViewed(formatDateTimeForDisplay(selectedEstimate.customerViewedAt, {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                        hour: "numeric",
                    ...
                    {selectedEstimate.customerDecisionAt ? (
                      <span className="muted">
                        {copy.share.customerDecision(formatDateTimeForDisplay(selectedEstimate.customerDecisionAt, {
                          month: "short",
                          day: "numeric",
                          year: "numeric",
                          hour: "numeric",
                          minute: "2-digit",
                        }, { locale: displayLocale }), selectedEstimate.customerDecisionName)}
                      </span>
                    ) : null}
                  </div>
                    ...
                    <div className="estimate-share-link-box" style={{ marginTop: 12 }}>
                      ...
                      <div className="portal-empty-actions">
                        <button className="btn secondary" type="button" disabled={copyingShare} onClick={() => void handleCopyShareLink()}>
                          {copyingShare ? copy.share.copying : copy.share.copyLink}
                        </button>
                      </div>
                    </div>
                  ) : selectedEstimate.latestShareLink ? (
                  ...
                  <div className="portal-empty-actions" style={{ marginTop: 12 }}>
                    ...
                    >
                      {sharing ? copy.share.generating : selectedEstimate.latestShareLink ? copy.share.refreshShareLink : copy.share.createShareLink}
                    </button>
                    <button
                      className="btn secondary"
                      type="button"
                    ...
                    >
                      {revokingShare ? copy.share.revoking : copy.share.revokeShareLink}
                    </button>
                    {latestShareUrl ? (
              ...
              <section className="estimate-module-section">
                ...
                <div className="portal-empty-actions" style={{ marginTop: 12 }}>
                  ...
                  >
                    {converting ? copy.actions.scheduling : copy.actions.scheduleJob}
                  </button>
                  <button
                    className="btn secondary"
                    type="button"
                  ...
                  >
                    {converting ? copy.actions.scheduling : copy.actions.scheduleJobDraftInvoice}
                  </button>
                    ...
                    {selectedEstimate.activities.map((activity) => (
                      <li key={activity.id} className="timeline-item">
                        ...
                        <div className="timeline-content">
                          <strong>{describeEstimateActivityTypeLocalized(activity.type, copy)}</strong>
                          <span className="muted">{activity.actorName}</span>
                          <span className="muted">{formatDateTimeForDisplay(activity.createdAt, {
                            month: "short",
                            day: "numeric",
                            year: "numeric",
                            hour: "numeric",
