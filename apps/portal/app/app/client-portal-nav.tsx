...
import {
  ...
  type PortalNavLinkId,
} from "@/lib/portal-navigation";

const navIcons: Record<PortalNavLinkId, ReactNode> = {
  today: (
...
export default function ClientPortalNav({
  ...
  const builderWorkspace = isBuilderWorkspace({ internalUser, portalVertical });
  const sections = resolvePortalNavSections({ internalUser, portalVertical });
